...
Public Class frmPaymentInformation
    ...
    '    TabControl1.SelectedTab = PostDatedCheque
    ...
    '            pbxPostDatedCheque.Image = Image.FromFile(d.FileName)
    ...
    '        If pbxPostDatedCheque.Image IsNot Nothing Then
    '            Dim mstream As New System.IO.MemoryStream()
    '            pbxPostDatedCheque.Image.Save(mstream, System.Drawing.Imaging.ImageFormat.Jpeg)
    ...
    '            pbxPostDatedCheque.Image = Nothing
    ...
    '                        Else
    '                            pbxPostDatedCheque.Image = Image.FromStream(ms)
    '                            TabControl1.SelectedTab = PostDatedCheque
    '                        End If
    '                    End Using
