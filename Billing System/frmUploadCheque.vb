...
Public Class frmUploadCheque
    ...
    '                            pbxCheque.Image = Image.FromStream(ms)
    '                        End Using
    ...
    '            pbxCheque.Image = Image.FromFile(d.FileName)
    ...
    'Private Sub btnSend_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
    '    If pbxCheque.Image IsNot Nothing AndAlso txtAmount.Text IsNot Nothing Then
    ...
    '                pbxCheque.Image.Save(mstream, System.Drawing.Imaging.ImageFormat.Jpeg)
